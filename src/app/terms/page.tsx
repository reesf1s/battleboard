export default function TermsPage() {
  return (
    ...
    >
      ...
      <p className="text-sm text-[var(--text-secondary)] mb-4">Last updated: April 2026</p>

      <div className="space-y-6 text-sm text-[var(--text-secondary)] leading-relaxed">
        <section>
          <h2 className="text-base font-semibold text-[var(--text-primary)] mb-2">Service</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--text-primary)] mb-2">Subscriptions</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--text-primary)] mb-2">Acceptable Use</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--text-primary)] mb-2">Fitness Disclaimer</h2>
