  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-sm text-[var(--text-secondary)] leading-relaxed">
        <section>
          <h2 className="text-base font-semibold text-[var(--text-primary)] mb-2">What We Collect</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--text-primary)] mb-2">How We Use It</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-[var(--text-primary)] mb-2">Your Rights</h2>
